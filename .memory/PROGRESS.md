...
- 2026-09-10 — phase3-step15 — user chạy workflow lần đầu: job build xanh (CI test + build web OK), job deploy đỏ vì OIDC timeout (E020) → workflow thêm retry deploy-pages + timeout; user Re-run — (hash ở dòng sau)
