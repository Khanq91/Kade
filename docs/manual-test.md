...
| 4.5 | Giao diện → Theo hệ thống, bật Dark theme hệ thống → app và widget dùng palette tối tương ứng, số ngày nghỉ đỏ nhạt. Chọn ép Sáng/Tối trong app → widget dùng đúng lựa chọn đó sau khi cập nhật. | — | ⬜ |
...
| R.7 | Widget Android mẫu 4c (thay phần mô tả giao diện cũ ở 4.1): thêm widget 2×2 và 4×2 sau khi mở app một lần. Cả hai có nền theo bộ màu đang chọn, đĩa sáng/tối chứa ngày dương, ngày âm ở bên phải; 4×2 có panel tương ứng với tối đa 3 sự kiện sắp tới, mỗi sự kiện có nhãn ÂL/DL, ngày, chấm màu và tên. Đổi lần lượt Hồng phấn → Xanh mint → một màu khác, chọn Sáng/Tối/Theo hệ thống trong Cài đặt → Giao diện: widget đổi màu ngay và chữ dễ đọc. Kiểm tra sự kiện ngày mai xuất hiện sau khi tạo, lớp sự kiện tắt không hiện, ngày nghỉ tô màu số ngày, chạm widget mở đúng ngày. Lặp các ca đổi ngày, dữ liệu quá 35 ngày và khởi động lại ở 4.1. | — | ⬜ |
